...
***The distribution IS skewed. This tells me that some courses may not be rated by students. This is not what I expected because I thought all the courses would have a rating.***
...
***Jitter adds space inbetween the spots so you can see the specific point that they are plotted. The misleading part about the initial scatterplot was that you dont know how many points fall in that spot.***
...
***For an average beauty rating of 0, the average evaluation rating is 3.88. This doesnt make sense in the data, as there are no beauty ratings that are 0.***
...
***A male professor on average scores 0.14 higher on evaluations than the female professor. On average, a female professors score 4.09 on the ratings.***
...
***The average rating for a tenure track professor is 4.14. The average rating for a teaching professor is 0.14 points higher than a tenured professor. The average rating for a tenure track professor is 0.02 points higher than a tenured professor.***
